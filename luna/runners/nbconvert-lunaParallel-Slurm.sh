...
echo "Running cmd: 'jupyter nbconvert --to notebook --execute "$SCANNAME" --output "$SCANNAME.out" --allow-errors'"
jupyter nbconvert --to notebook --execute "$SCANNAME" --output "$SCANNAME.out" --allow-errors
